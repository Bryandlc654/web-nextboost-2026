...
<script type="application/ld+json">
{
  ...
  "@graph": [
      ...
      "hasOfferCatalog": {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "itemOffered": {
              "@type": "Service",
              "name": "Plan Informativa Gimnasio"
            }
          },
          {
            "@type": "Offer",
            ...
            "itemOffered": {
              "@type": "Service",
              "name": "Plan Profesional Gimnasio"
            }
          },
          {
            "@type": "Offer",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://nextboost.business/pagina-web-gimnasios-peru.php/#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
    ...
    {
      "@type": "FAQPage",
      "@id": "https://nextboost.business/pagina-web-gimnasios-peru.php/#faq",
      "mainEntity": [
        {
          "@type": "Question",
...
<body>
  ...
  <div class="fixed inset-0 pointer-events-none z-0 overflow-hidden">
    <div class="absolute -top-40 -left-40 w-[600px] h-[600px] bg-red-600/10 rounded-full glow-pulse"></div>
    <div class="absolute bottom-[20%] -right-40 w-[500px] h-[500px] bg-orange-500/5 rounded-full glow-pulse" style="animation-delay: -1.5s;"></div>
  ...
  <main class="relative z-10 max-w-screen-2xl mx-auto px-8 md:px-16 lg:px-20 py-16 lg:py-24">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
      ...
      <div class="lg:col-span-7 space-y-6">
        <div class="inline-flex items-center gap-2.5 px-4 py-1.5 badge-gradient text-xs font-medium text-red-300 animate-in">
          <span class="w-2 h-2 rounded-full bg-red-500 animate-pulse"></span>
          <span class="tracking-wide">Soluciones Web para Gimnasios y Fitness</span>
        </div>
        ...
        <div class="grid grid-cols-3 gap-4 pt-4 border-t border-white/10 max-w-xl">
          ...
          <div class="glass-card p-3 rounded-none text-center border border-red-500/20">
            <span class="text-2xl md:text-3xl font-extrabold text-red-300 block">&lt;0.8s</span>
            <span class="text-[10px] text-gray-400 uppercase tracking-wider font-semibold">Tiempo Carga</span>
          </div>
        </div>

        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-4">
          <a href="contacto.php?servicio=gimnasios" class="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-red-500 to-orange-500 text-white px-8 py-4 text-sm font-bold rounded-none hover:shadow-[0_0_30px_rgba(239,68,68,0.4)] hover:scale-105 transition-all btn-primary group">
            Cotizar Mi Web de Gimnasio
        ...
        <div class="glass-card rounded-2xl p-6 border border-white/10 space-y-6 relative overflow-hidden bg-gradient-to-b from-[#121217] to-[#08080a]">
          ...
          <div class="space-y-3">
            ...
            <div class="p-3 bg-white/5 border border-white/10 flex items-center gap-3">
              ...
              <span class="text-xs font-bold text-yellow-400">S/ 850</span>
            </div>
          </div>
          <div class="grid grid-cols-2 gap-3 pt-2">
            <div class="p-2.5 bg-white/5 border border-white/5 text-center">
              <span class="text-lg font-extrabold text-red-400 block">+350</span>
              <span class="text-[10px] text-gray-400">Socios Activos</span>
            </div>
            <div class="p-2.5 bg-white/5 border border-white/5 text-center">
              <span class="text-lg font-extrabold text-orange-400 block">12</span>
              <span class="text-[10px] text-gray-400">Clases Semanales</span>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="relative z-10 py-20 max-w-screen-2xl mx-auto px-8 md:px-16 lg:px-20">
    <div class="text-center max-w-3xl mx-auto mb-16">
      <p class="text-xs uppercase tracking-widest text-orange-400 font-bold mb-3">Funcionalidades que Inspiran</p>
      <h2 class="text-3xl md:text-5xl font-semibold tracking-tight text-white">
        Todo lo que tu gimnasio <span class="bg-gradient-to-r from-red-400 to-orange-500 text-transparent bg-clip-text">necesita online</span>
      </h2>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <article class="glass-card p-8 rounded-2xl border border-white/5 space-y-4 hover:border-yellow-500/30 transition-all group">
        <div class="w-12 h-12 rounded-none bg-yellow-500/10 border border-yellow-500/20 flex items-center justify-center text-yellow-400 group-hover:bg-yellow-500 group-hover:text-black transition-all">
          <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
        </div>
        <h3 class="text-xl font-bold text-white">Perfiles de Entrenadores</h3>
        <p class="text-xs text-gray-400 leading-relaxed">Fotos, especialidades, certificaciones y contacto directo de cada entrenador. Genera confianza y fideliza a tus socios.</p>
      </article>
      ...
      <article class="glass-card p-8 rounded-2xl border border-white/5 space-y-4 hover:border-pink-500/30 transition-all group">
        ...
        <h3 class="text-xl font-bold text-white">Promociones y Descuentos</h3>
        <p class="text-xs text-gray-400 leading-relaxed">Publica ofertas especiales, meses gratis, descuentos por referidos y promociones de bienvenida que conviertan prospectos.</p>
      </article>
  ...
  <section class="relative z-10 py-20 max-w-screen-2xl mx-auto px-8 md:px-16 lg:px-20">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
      <div class="lg:col-span-4 space-y-4">
        <p class="text-xs uppercase tracking-widest text-orange-400 font-bold">Resolvemos tus dudas</p>
        <h2 class="text-3xl md:text-4xl font-semibold tracking-tight text-white leading-tight">
          Preguntas Frecuentes sobre <span class="bg-gradient-to-r from-red-400 to-orange-500 text-transparent bg-clip-text">Webs para Gimnasios</span>
        </h2>
        <p class="text-xs text-gray-400 leading-relaxed">Todo lo que necesitas saber antes de crear la web de tu gimnasio.</p>
      </div>
  ...
  <section class="relative z-10 py-16 px-8 md:px-16 lg:px-20 max-w-screen-2xl mx-auto mb-16">
    <div class="glass-card rounded-3xl p-10 md:p-16 border border-red-500/30 bg-gradient-to-r from-red-950/40 via-[#121216] to-orange-950/40 relative overflow-hidden text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-8">
