<?php
  $page_title = "Página Web Veterinarias Perú | Diseño Web para Veterinarias | Next Boost";
  $page_description = "Creamos páginas web profesionales para veterinarias en Perú. Diseño moderno, agenda de citas online, catálogo de servicios y WhatsApp integrado.";
  $og_url = "https://nextboost.business/pagina-web-veterinarias-peru.php";
?>
<!DOCTYPE html>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://nextboost.business/pagina-web-veterinarias-peru.php/#service",
      "name": "Página Web Profesional para Veterinarias en Perú",
      "serviceType": "Diseño Web Veterinarias",
      "provider": {
        "@type": "Organization",
        "name": "Next Boost",
      ...
      "description": "Diseño de páginas web modernas para veterinarias en Perú con agenda de citas online, catálogo de servicios, galería de mascotas e integración con WhatsApp.",
      "areaServed": {
        "@type": "Country",
        "name": "Perú"
      },
      "hasOfferCatalog": {
        "@type": "OfferCatalog",
        "name": "Planes Web para Veterinarias",
        "itemListElement": [
          {
            "@type": "Offer",
            "price": "450.00",
            ...
            "itemOffered": {
              "@type": "Service",
              "name": "Plan Básico Web Veterinaria"
            }
          },
          {
            "@type": "Offer",
            ...
            "itemOffered": {
              "@type": "Service",
              "name": "Plan Informativa Web Veterinaria"
            }
          },
          {
            "@type": "Offer",
            ...
            "itemOffered": {
              "@type": "Service",
              "name": "Plan Profesional Web Veterinaria"
            }
          },
          {
            "@type": "Offer",
            ...
            "itemOffered": {
              "@type": "Service",
              "name": "Plan Premium Web Veterinaria"
            }
          }
        ]
      },
      "url": "https://nextboost.business/pagina-web-veterinarias-peru.php",
      "image": "https://nextboost.business/imagenes-web/next-boost.png"
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://nextboost.business/pagina-web-veterinarias-peru.php/#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          "@type": "ListItem",
          "position": 2,
          "name": "Página Web Veterinarias Perú",
          "item": "https://nextboost.business/pagina-web-veterinarias-peru.php"
        }
      ]
    },
    {
      "@type": "FAQPage",
      "@id": "https://nextboost.business/pagina-web-veterinarias-peru.php/#faq",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "¿Pueden los clientes agendar citas online en mi veterinaria?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Sí, integramos un sistema de agendamiento de citas online disponible las 24 horas. Tus clientes pueden reservar consultas generales, vacunaciones, desparasitaciones y peluquería directamente desde la página web, sin necesidad de llamar. Recibes notificaciones en tiempo real y reduces lasausencias con recordatorios automáticos."
          }
        },
        {
          "@type": "Question",
          "name": "¿La página web incluye galería de fotos?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Sí, diseñamos una galería profesional donde puedes mostrar las instalaciones de tu veterinaria, las áreas de atención, fotos de mascotas atendidas, resultados de estética antes y después, y todo lo que necesites para generar confianza en tus potenciales clientes."
          }
        },
        {
          "@type": "Question",
          "name": "¿Se integra con WhatsApp para contacto directo?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Sí, incluimos un botón flotante de WhatsApp con mensaje predefinido para que tus clientes puedan reportar emergencias veterinarias y recibir atención inmediata. El botón está visible en todas las páginas y facilita la comunicación directa con tu equipo."
          }
        }
      ]
    }
...
<body>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
      ...
      <div class="lg:col-span-7 space-y-6">
        <div class="inline-flex items-center gap-2.5 px-4 py-1.5 badge-gradient text-xs font-medium text-blue-300 animate-in">
          ...
          <span class="tracking-wide">Especialistas en Páginas Web para Veterinarias</span>
        </div>

        <h1 class="text-4xl md:text-6xl font-extrabold tracking-tight text-white leading-[1.1]">
          Página Web para Veterinarias <br>
          <span class="gradient-text">en Perú</span>
        </h1>

        <p class="text-base md:text-lg text-gray-300 font-normal leading-relaxed max-w-2xl">
          Creamos páginas web modernas para veterinarias en Perú con <strong class="text-white">agenda de citas online</strong>, catálogo de servicios, galería de mascotas y <strong class="text-teal-400">WhatsApp integrado</strong>. Diseñadas para atraer más clientes y gestionar tu clínica veterinaria de forma digital.
        </p>
        ...
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-4">
          <a href="contacto.php?servicio=veterinarias" class="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-blue-500 to-teal-400 text-black px-8 py-4 text-sm font-bold rounded-none hover:shadow-[0_0_30px_rgba(59,130,246,0.4)] hover:scale-105 transition-all btn-primary group">
            Cotizar Mi Veterinaria
        ...
        <div class="glass-card rounded-2xl p-6 border border-white/10 space-y-6 relative overflow-hidden bg-gradient-to-b from-[#121217] to-[#08080a]">
          ...
          <div class="flex items-center justify-between border-b border-white/10 pb-4">
            <span class="text-xs font-mono text-gray-400 flex items-center gap-2">
              ...
              Veterinarias con Presencia Digital
            </span>
          ...
          <div class="space-y-2 font-mono text-xs">
            <div class="p-2.5 bg-white/5 border border-white/5 flex items-center justify-between">
              <span class="text-gray-400">Citas Online Activas</span>
              <span class="text-emerald-400 font-bold">Funcional</span>
            </div>
            <div class="p-2.5 bg-white/5 border border-white/5 flex items-center justify-between">
              <span class="text-gray-400">WhatsApp Integrado</span>
              <span class="text-emerald-400 font-bold">Conectado</span>
            </div>
            <div class="p-2.5 bg-white/5 border border-white/5 flex items-center justify-between">
              <span class="text-gray-400">Google Maps</span>
              <span class="text-emerald-400 font-bold">Visible</span>
            </div>
          </div>

          <p class="text-[11px] text-gray-400 text-center leading-relaxed">
            🐾 Tu veterinaria merece una web profesional que genere confianza y facilite la agendación de citas para tus clientes.
          </p>
    ...
    <div class="max-w-screen-2xl mx-auto px-8 md:px-16 lg:px-20">
      ...
      <div class="text-center max-w-3xl mx-auto mb-16">
        ...
        <h2 class="text-3xl md:text-5xl font-semibold tracking-tight text-white">
          ¿Por qué nuestras webs <span class="gradient-text">superan a la competencia</span>?
        </h2>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
        ...
        <div class="glass-card p-8 rounded-2xl border border-red-500/20 bg-red-950/10 space-y-6">
          <div class="flex items-center gap-3 border-b border-red-500/20 pb-4">
            ...
            <h3 class="text-xl font-bold text-white">Otras Agencias</h3>
          </div>
          <ul class="space-y-4 text-xs text-gray-300">
            <li class="flex items-start gap-3">
              <span class="text-red-400 font-bold shrink-0">✕</span>
              <span><strong>Sin agenda de citas:</strong> Los clientes deben llamar para agendar, perdiendo consultas fuera de horario.</span>
            </li>
            <li class="flex items-start gap-3">
              <span class="text-red-400 font-bold shrink-0">✕</span>
              <span><strong>Diseño genérico y aburrido:</strong> Plantillas reutilizables que no transmiten profesionalismo ni confianza.</span>
            </li>
            <li class="flex items-start gap-3">
              <span class="text-red-400 font-bold shrink-0">✕</span>
              <span><strong>Sin integración WhatsApp:</strong> Los dueños pierden clientes por no responder rápido emergencias.</span>
            </li>
            <li class="flex items-start gap-3">
              <span class="text-red-400 font-bold shrink-0">✕</span>
              <span><strong>Carga lenta en celular:</strong> Más del 70% de búsquedas veterinarias se hacen desde el teléfono.</span>
            </li>
          </ul>
        </div>
        ...
        <div class="glass-card p-8 rounded-2xl border-2 border-emerald-500/30 bg-emerald-950/10 space-y-6">
          <div class="flex items-center gap-3 border-b border-emerald-500/20 pb-4">
            ...
            <h3 class="text-xl font-bold text-white">Páginas Web Next Boost</h3>
          </div>
          <ul class="space-y-4 text-xs text-gray-200">
            <li class="flex items-start gap-3">
              <span class="text-emerald-400 font-bold shrink-0">✓</span>
              <span><strong>Agenda de citas 24/7:</strong> Tus clientes agendan vacunas, consultas y peluquería a cualquier hora.</span>
            </li>
            <li class="flex items-start gap-3">
              <span class="text-emerald-400 font-bold shrink-0">✓</span>
              <span><strong>Diseño a medida para veterinarias:</strong> Galería de mascotas, catálogo de servicios e identidad única de marca.</span>
            </li>
            <li class="flex items-start gap-3">
              <span class="text-emerald-400 font-bold shrink-0">✓</span>
              <span><strong>WhatsApp flotante con mensaje predefinido:</strong> Atención inmediata para emergencias veterinarias.</span>
            </li>
            <li class="flex items-start gap-3">
              <span class="text-emerald-400 font-bold shrink-0">✓</span>
              <span><strong>Ultra rápida en celular:</strong> Carga en menos de 0.8 segundos, puntuación 99/100 en PageSpeed.</span>
            </li>
          </ul>
        </div>
  ...
  <section class="relative z-10 py-20 max-w-screen-2xl mx-auto px-8 md:px-16 lg:px-20">
    <div class="text-center max-w-3xl mx-auto mb-16">
      <p class="text-xs uppercase tracking-widest text-teal-400 font-bold mb-3">Todo lo que tu Veterinaria Necesita</p>
      <h2 class="text-3xl md:text-5xl font-semibold tracking-tight text-white">
        Funcionalidades <span class="gradient-text">Diseñadas para ti</span>
      </h2>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <article class="glass-card p-8 rounded-2xl border border-white/5 space-y-4 hover:border-blue-500/30 transition-all group">
        ...
        <p class="text-xs text-gray-400 leading-relaxed">
          Sistema de agendamiento 24/7 para consultas, vacunaciones, desparasitaciones y peluquería. Tus clientes reservan sin llamarte.
        </p>
      </article>
      ...
      <article class="glass-card p-8 rounded-2xl border border-white/5 space-y-4 hover:border-teal-500/30 transition-all group">
        ...
        <h3 class="text-xl font-bold text-white">Catálogo de Servicios</h3>
        <p class="text-xs text-gray-400 leading-relaxed">
          Muestra todos tus servicios con precios, descripciones y duración: consultas generales, cirugías, vacunas, estética y laboratorio.
        </p>
      </article>
      ...
      <article class="glass-card p-8 rounded-2xl border border-white/5 space-y-4 hover:border-purple-500/30 transition-all group">
        ...
        <h3 class="text-xl font-bold text-white">Galería de Mascotas</h3>
        <p class="text-xs text-gray-400 leading-relaxed">
          Galería profesional para mostrar instalaciones, equipo médico, fotos antes y después de estética, y testimonios de clientes satisfechos.
        </p>
      </article>
      ...
      <article class="glass-card p-8 rounded-2xl border border-white/5 space-y-4 hover:border-pink-500/30 transition-all group">
        ...
        <p class="text-xs text-gray-400 leading-relaxed">
          Botón flotante con mensaje personalizado para consultas urgentes. Tus clientes reportan emergencias y reciben atención inmediata.
        </p>
      </article>
      ...
      <article class="glass-card p-8 rounded-2xl border border-white/5 space-y-4 hover:border-cyan-500/30 transition-all group">
        ...
        <h3 class="text-xl font-bold text-white">Ubicación con Google Maps</h3>
        <p class="text-xs text-gray-400 leading-relaxed">
          Mapa interactivo integrado para que los clientes encuentren fácilmente tu veterinaria. Incluye horarios, dirección y ruta de llegada.
        </p>
      </article>
      ...
      <article class="glass-card p-8 rounded-2xl border border-white/5 space-y-4 hover:border-emerald-500/30 transition-all group">
        ...
        <h3 class="text-xl font-bold text-white">SEO Local para Veterinarias</h3>
        <p class="text-xs text-gray-400 leading-relaxed">
          Optimización para aparecer en Google Maps y búsquedas como "veterinaria cerca de mí". Atrae clientes de tu zona automáticamente.
        </p>
      </article>
  ...
  <section class="relative z-10 py-20 max-w-screen-2xl mx-auto px-8 md:px-16 lg:px-20 border-t border-white/5 bg-[#0a0a0e]/50">
    <div class="text-center max-w-3xl mx-auto mb-16">
      <p class="text-xs uppercase tracking-widest text-emerald-400 font-bold mb-3">Planes para tu Veterinaria</p>
      <h2 class="text-3xl md:text-5xl font-semibold tracking-tight text-white">
        Precios <span class="gradient-text">Claros y Directos</span>
      </h2>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-6xl mx-auto">
      ...
      <div class="glass-card p-8 rounded-2xl border border-white/10 hover:border-teal-500/50 transition-all flex flex-col h-full group">
        ...
        <p class="text-xs text-gray-400 mb-6">Ideal para veterinarias que quieren presencia digital básica con contacto directo.</p>
        ...
        <ul class="space-y-4 text-xs text-gray-300 mb-8 flex-1">
          <li class="flex items-start gap-3"><span class="text-teal-400 font-bold shrink-0">✓</span> Landing Page Profesional</li>
          <li class="flex items-start gap-3"><span class="text-teal-400 font-bold shrink-0">✓</span> Catálogo de Servicios</li>
        ...
        <a href="contacto.php?servicio=veterinarias&plan=basico" class="w-full inline-block text-center py-3 text-sm font-bold bg-white/5 hover:bg-teal-500 hover:text-black border border-white/10 hover:border-teal-500 transition-all">
          Cotizar Plan Básico
        </a>
      </div>
      ...
      <div class="glass-card p-8 rounded-2xl border border-white/10 hover:border-teal-500/50 transition-all flex flex-col h-full group">
        ...
        <p class="text-xs text-gray-400 mb-6">Para veterinarias que quieren ampliar su presencia digital con secciones informativas y más contenido.</p>
        <div class="mb-6 border-b border-white/10 pb-6">
        ...
        <ul class="space-y-4 text-xs text-gray-300 mb-8 flex-1">
          ...
          <li class="flex items-start gap-3"><span class="text-teal-400 font-bold shrink-0">✓</span> Hasta 3 Secciones Informativas</li>
          <li class="flex items-start gap-3"><span class="text-teal-400 font-bold shrink-0">✓</span> Galería de Mascotas y Clínica</li>
          <li class="flex items-start gap-3"><span class="text-teal-400 font-bold shrink-0">✓</span> Servicios y Precios Detallados</li>
          <li class="flex items-start gap-3"><span class="text-teal-400 font-bold shrink-0">✓</span> Formulario de Citas y Consultas</li>
        </ul>
        <a href="contacto.php?servicio=veterinarias&plan=informativa" class="w-full inline-block text-center py-3 text-sm font-bold bg-white/5 hover:bg-teal-500 hover:text-black border border-white/10 hover:border-teal-500 transition-all">
      ...
      <div class="glass-card p-8 rounded-2xl border border-emerald-500/50 relative bg-emerald-950/10 flex flex-col h-full group transform md:-translate-y-4 shadow-[0_15px_30px_rgba(16,185,129,0.15)]">
        ...
        <p class="text-xs text-gray-400 mb-6">Para veterinarias que necesitan agendar citas online y mostrar su catálogo completo.</p>
        <div class="mb-6 border-b border-white/10 pb-6">
        ...
        <ul class="space-y-4 text-xs text-gray-300 mb-8 flex-1">
          ...
          <li class="flex items-start gap-3"><span class="text-emerald-400 font-bold shrink-0">✓</span> Agenda de Citas Online</li>
          <li class="flex items-start gap-3"><span class="text-emerald-400 font-bold shrink-0">✓</span> Galería de Fotos Profesional</li>
          <li class="flex items-start gap-3"><span class="text-emerald-400 font-bold shrink-0">✓</span> Google Maps Integrado</li>
          <li class="flex items-start gap-3"><span class="text-emerald-400 font-bold shrink-0">✓</span> SEO Local Optimizado</li>
        </ul>
        <a href="contacto.php?servicio=veterinarias&plan=profesional" class="w-full inline-block text-center py-3 text-sm font-bold bg-emerald-500 text-black hover:bg-emerald-400 transition-all shadow-[0_0_15px_rgba(16,185,129,0.4)]">
      ...
      <div class="glass-card p-8 rounded-2xl border border-white/10 hover:border-purple-500/50 transition-all flex flex-col h-full group">
        ...
        <p class="text-xs text-gray-400 mb-6">Veterinarias con múltiples sucursales que necesitan gestión completa digital.</p>
        <div class="mb-6 border-b border-white/10 pb-6">
        ...
        <ul class="space-y-4 text-xs text-gray-300 mb-8 flex-1">
          ...
          <li class="flex items-start gap-3"><span class="text-purple-400 font-bold shrink-0">✓</span> Múltiples Sucursales</li>
          <li class="flex items-start gap-3"><span class="text-purple-400 font-bold shrink-0">✓</span> Blog de Salud Animal</li>
          <li class="flex items-start gap-3"><span class="text-purple-400 font-bold shrink-0">✓</span> Recordatorios Automáticos</li>
          <li class="flex items-start gap-3"><span class="text-purple-400 font-bold shrink-0">✓</span> Panel de Gestión Avanzado</li>
        </ul>
        <a href="contacto.php?servicio=veterinarias&plan=premium" class="w-full inline-block text-center py-3 text-sm font-bold bg-white/5 hover:bg-purple-500 hover:text-white border border-white/10 hover:border-purple-500 transition-all">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
      ...
      <div class="lg:col-span-4 space-y-4">
        ...
        <h2 class="text-3xl md:text-4xl font-semibold tracking-tight text-white leading-tight">
          Preguntas Frecuentes sobre <span class="gradient-text">Páginas Web para Veterinarias</span>
        </h2>
        <p class="text-xs text-gray-400 leading-relaxed">
          Consulta todo lo que necesitas saber para digitalizar tu veterinaria con una web profesional.
        </p>
      </div>
      ...
      <div class="lg:col-span-8 space-y-4">
        ...
        <div class="glass-card rounded-xl p-6 border border-white/10 space-y-2">
          <h3 class="text-base font-bold text-white flex items-center gap-2">
            <span class="text-blue-400">01.</span> ¿Pueden los clientes agendar citas online en mi veterinaria?
          </h3>
          <p class="text-xs text-gray-400 leading-relaxed pt-1">
            Sí, integramos un sistema de agendamiento de citas online disponible las 24 horas. Tus clientes pueden reservar consultas generales, vacunaciones, desparasitaciones y peluquería directamente desde la página web, sin necesidad de llamar. Recibes notificaciones en tiempo real y reduces lasausencias con recordatorios automáticos.
          </p>
        </div>

        <div class="glass-card rounded-xl p-6 border border-white/10 space-y-2">
          <h3 class="text-base font-bold text-white flex items-center gap-2">
            <span class="text-blue-400">02.</span> ¿La página web incluye galería de fotos?
          </h3>
          <p class="text-xs text-gray-400 leading-relaxed pt-1">
            Sí, diseñamos una galería profesional donde puedes mostrar las instalaciones de tu veterinaria, las áreas de atención, fotos de mascotas atendidas, resultados de estética antes y después, y todo lo que necesites para generar confianza en tus potenciales clientes.
          </p>
        </div>

        <div class="glass-card rounded-xl p-6 border border-white/10 space-y-2">
          <h3 class="text-base font-bold text-white flex items-center gap-2">
            <span class="text-blue-400">03.</span> ¿Se integra con WhatsApp para contacto directo?
          </h3>
          <p class="text-xs text-gray-400 leading-relaxed pt-1">
            Sí, incluimos un botón flotante de WhatsApp con mensaje predefinido para que tus clientes puedan reportar emergencias veterinarias y recibir atención inmediata. El botón está visible en todas las páginas y facilita la comunicación directa con tu equipo.
          </p>
        </div>
  ...
  <section class="relative z-10 py-16 px-8 md:px-16 lg:px-20 max-w-screen-2xl mx-auto mb-16">
    <div class="glass-card rounded-3xl p-10 md:p-16 border border-blue-500/30 bg-gradient-to-r from-blue-950/40 via-[#121216] to-teal-950/40 relative overflow-hidden text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-8">
      ...
      <div class="space-y-4 max-w-2xl">
        <span class="text-[10px] uppercase tracking-widest text-teal-400 font-extrabold bg-teal-500/10 px-3 py-1 border border-teal-500/20">Digitaliza tu Veterinaria</span>
        <h2 class="text-3xl md:text-5xl font-bold tracking-tight text-white leading-tight">
          ¿Listo para que tu veterinaria tenga más clientes online?
        </h2>
        <p class="text-sm text-gray-300 leading-relaxed">
          Cuéntanos sobre tu veterinaria. Te entregamos una propuesta personalizada con diseño, agenda de citas y todo lo que necesitas para crecer.
        </p>
      </div>

      <div class="shrink-0 flex flex-col items-center gap-4">
        <a href="contacto.php?servicio=veterinarias" class="inline-flex items-center gap-3 bg-gradient-to-r from-blue-500 to-teal-400 text-black px-8 py-4 text-sm font-bold rounded-none hover:shadow-[0_0_30px_rgba(59,130,246,0.4)] hover:scale-105 transition-all btn-primary">
