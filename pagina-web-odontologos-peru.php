...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://nextboost.business/pagina-web-odontologos-peru.php/#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
    ...
    {
      "@type": "FAQPage",
      "@id": "https://nextboost.business/pagina-web-odontologos-peru.php/#faq",
      "mainEntity": [
        {
          "@type": "Question",
...
<body>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
      ...
      <div class="lg:col-span-7 space-y-6">
        ...
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-4">
          <a href="contacto.php?servicio=web-odontologos" class="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-blue-500 to-teal-400 text-black px-8 py-4 text-sm font-bold rounded-none hover:shadow-[0_0_30px_rgba(59,130,246,0.4)] hover:scale-105 transition-all btn-primary group">
            Cotizar Mi Web Dental
        ...
        <div class="glass-card rounded-2xl p-6 border border-white/10 space-y-6 relative overflow-hidden bg-gradient-to-b from-[#121217] to-[#08080a]">
          ...
          <div class="flex items-center justify-between border-b border-white/10 pb-4">
            <span class="text-xs font-mono text-gray-400 flex items-center gap-2">
              ...
              Web Dental Optimizada
            </span>
            <span class="text-[10px] font-bold text-emerald-400 bg-emerald-500/10 px-2.5 py-1 border border-emerald-500/20">LISTO PARA PACIENTES</span>
          </div>
          ...
          <div class="space-y-3">
            <div class="p-3 bg-white/5 border border-white/10 flex items-center gap-3">
              ...
              <div>
                <span class="text-xs font-bold text-white block">Agendamiento de Citas</span>
                <span class="text-[10px] text-gray-400">Pacientes reservan turnos 24/7</span>
              </div>
            </div>
            <div class="p-3 bg-white/5 border border-white/10 flex items-center gap-3">
            ...
            <div class="p-3 bg-white/5 border border-white/10 flex items-center gap-3">
              ...
              <div>
                <span class="text-xs font-bold text-white block">Lista de Servicios</span>
                <span class="text-[10px] text-gray-400">Especialidades, tratamientos y precios</span>
              </div>
            </div>
            <div class="p-3 bg-white/5 border border-white/10 flex items-center gap-3">
              ...
              <div>
                <span class="text-xs font-bold text-white block">WhatsApp Integrado</span>
                <span class="text-[10px] text-gray-400">Contacto directo con un clic</span>
              </div>
            </div>
          </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
        ...
        <div class="glass-card p-8 rounded-2xl border-2 border-emerald-500/30 bg-emerald-950/10 space-y-6">
          <div class="flex items-center gap-3 border-b border-emerald-500/20 pb-4">
            ...
            <h3 class="text-xl font-bold text-white">Web Dental Next Boost</h3>
          </div>
  ...
  <section class="relative z-10 py-20 max-w-screen-2xl mx-auto px-8 md:px-16 lg:px-20">
    <div class="text-center max-w-3xl mx-auto mb-16">
      <p class="text-xs uppercase tracking-widest text-teal-400 font-bold mb-3">Funcionalidades Dentales</p>
      <h2 class="text-3xl md:text-5xl font-semibold tracking-tight text-white">
        Todo lo que tu consultorio <span class="gradient-text">necesita online</span>
      </h2>
    </div>
